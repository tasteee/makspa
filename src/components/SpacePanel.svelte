<script lang="ts">
	...
	const colorsSectionOpen = useToggler(true)
...
<ShePanel side="left" title="Space" {isOpen}>
	{#if space.id}
		<ShePanelSection label="Main" isOpen={infoSectionOpen.value} onClick={infoSectionOpen.toggle}>
			...
			<ShePanelInnerSection
				label="Visibility"
				row
				isOpen={visibilitySectionOpen.value}
				onClick={visibilitySectionOpen.toggle}
			>
		...
		<ShePanelSection label="Grid" isOpen={gridSectionOpen.value} onClick={gridSectionOpen.toggle}>
			...
			{#if space.isGridVisible}
				...
				<ShePanelInnerSection
					label="Section Lines"
					isOpen={sectionsSectionOpen.value}
					onClick={sectionsSectionOpen.toggle}
				>
				...
				<ShePanelInnerSection label="Grid Background" isOpen={floorColorOpen1.value} onClick={floorColorOpen1.toggle}>
